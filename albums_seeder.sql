...
INSERT INTO albums(artist, album_name, release_date, genre,total_certified_copies,sales)
values ('Michael Jackson', 'Thriller', '1982', 'Pop, rock, R&B',47.3,66),
    ('AC/DC', 'Back in Black', '1980', 'Hard rock', 26.4, 50),
    ('Meat Loaf', 'Bat Out of Hell', '1977', 'Hard rock', 21.7, 50),
    ...
    ('Eagles', 'Their Greatest Hits (1971–1975)', '1976', 'Country rock, soft rock, folk rock', 41.2, 42),
    ...
    ('Various artists', 'Grease', '1978', 'Rock and roll', 14.4, 38),
    ('Led Zeppelin', 'Led Zeppelin IV', '1971', 'Hard rock, heavy metal, folk rock', 29.0, 37),
    ('Michael Jackson', 'Bad', '1987', 'Pop, dance, funk, rock', 22.2, 35),
    ...
    ('Michael Jackson', 'Dangerous', '1991', 'Rock, funk, pop', 17.3, 32),
